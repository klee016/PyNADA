...
print(search_catalog.list_resources('BGD_RRRC-UNHCR-IOM_20190108'))

#print(search_catalog.list_datafiles('BGD_RRRC-UNHCR-IOM_20190108'))

#print(search_catalog.list_files('BGD_RRRC-UNHCR-IOM_20190108'))